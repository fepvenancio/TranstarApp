...
namespace TRTv10.Disposable
{
    public abstract class DisposableBase : IDisposable
    {
        ...
        ///     If disposing equals false, the method has been called by the runtime from inside the <c>finalizer</c> and you
        ///     should not reference other objects.
